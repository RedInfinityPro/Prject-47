...
# Rocket Content
class RocketContent:
    def __init__(self, ui_manager, scroll_container, screen_size):
        self.ui_manager = ui_manager
        self.scroll_container = scroll_container
        self.screenWidth, self.screenHeight = screen_size
        self.name = f"Rocket Name: {BusinessName()}"
        self.key = generate_secure_key(12)
        self.cost = Large_Number_Random_Generator(10**6, sys.maxsize)
        self.fuelUse = Weighted_Random(50, 5000, 10)
        self.distance = Large_Number_Random_Generator(1000, sys.maxsize, 10)
        self.upKeep = Weighted_Random(0.01, 50000, 20)
        self.storage = Weighted_Random(1, 50000, 20)
...
class RocketUpgrade:
    def __init__(self, ui_manager, scroll_container, screenSize):
        ...
        self.name = f"Rocket Upgrade: {BusinessName()}"
        self.key = generate_secure_key(12)
